...
impl ZedAiOnboarding {
    ...
    fn render_trial_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to the Neo Zed Pro Trial"))
            .child(
    ...
    fn render_pro_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to Neo Zed Pro"))
            .child(
    ...
    fn render_business_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to Neo Zed Business"))
            .child(
                Label::new("Here's what you get:")
                    .color(Color::Muted)
                    .mb_2(),
    ...
    fn render_student_plan_state(&self, cx: &mut App) -> AnyElement {
        v_flex()
            ...
            .child(Headline::new("Welcome to Neo Zed Student"))
            .child(
                Label::new("Here's what you get:")
                    .color(Color::Muted)
                    .mb_2(),
