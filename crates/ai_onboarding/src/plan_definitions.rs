...
/// Centralized definitions for Neo Zed AI plans
...
impl PlanDefinitions {
    ...
    pub fn pro_trial(&self, period: bool) -> impl IntoElement {
        List::new()
            .child(ListBulletItem::new("$20 of tokens in Neo Zed agent"))
    ...
    pub fn pro_plan(&self) -> impl IntoElement {
        List::new()
            .child(ListBulletItem::new("$5 of tokens in Neo Zed agent"))
