...
fn address() -> SocketAddr {
    ...
    let port = match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => 46737,
        ReleaseChannel::Preview => 46737 + USER_BLOCK,
        ReleaseChannel::Stable => 46737 + (2 * USER_BLOCK),
        ReleaseChannel::Nightly => 46737 + (3 * USER_BLOCK),
    };
...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Neo Zed Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Neo Zed Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Neo Zed Editor Preview Instance Running",
        ReleaseChannel::Stable => "Neo Zed Editor Stable Instance Running",
    }
}
