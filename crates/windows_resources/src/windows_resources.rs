...
pub fn compile(manifest: bool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (icon_filename, product_name) = match channel {
        "stable" => ("app-icon.ico", "Neo Zed"),
        "preview" => ("app-icon-preview.ico", "Neo Zed Preview"),
        "nightly" => ("app-icon-nightly.ico", "Neo Zed Nightly"),
        _ => ("app-icon-dev.ico", "Neo Zed Dev"),
    };
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "CompanyName", "Neo Zed Industries\0"
