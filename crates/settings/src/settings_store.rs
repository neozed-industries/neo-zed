...
pub const LSP_SETTINGS_SCHEMA_URL_PREFIX: &str = "neozed://schemas/settings/lsp/";
...
mod tests {
    ...
    fn test_lsp_settings_schema_generation(cx: &mut App) {
        ...
        assert_eq!(
            init_options_ref,
            "neozed://schemas/settings/lsp/rust-analyzer/initialization_options"
        );
        ...
        assert_eq!(
            settings_ref,
            "neozed://schemas/settings/lsp/rust-analyzer/settings"
        );
    }
