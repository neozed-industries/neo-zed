---
title: Neo Zed-Hosted Models - Neo Zed
description: AI models available via Neo Zed Pro including Claude, GPT-5.5, Gemini 3.1 Pro, and Gemini 3.5 Flash. Pricing, context windows, and tool call support.
---

# Neo Zed-Hosted Models

Neo Zed's plans offer hosted versions of major LLMs with higher rate limits than direct API access. Model availability is updated regularly. To use your own API keys instead, see [LLM Providers](../ai/llm-providers.md). For general setup, see [AI Quick Start](../ai/quick-start.md).

> **Note:** Claude Opus models, GPT-5.5 pro, and GPT-5.4 pro are only available on Neo Zed Pro and Neo Zed Business.

| Model             | Provider  | Token Type          | Provider Price per 1M tokens | Neo Zed Price per 1M tokens |
| ----------------- | --------- | ------------------- | ---------------------------- | ----------------------- |
...
| Model             | Provider  | Neo Zed-Hosted Context Window |
| ----------------- | --------- | ------------------------- |
...
> Neo Zed currently limits hosted Gemini 3.1 Pro requests to 200k tokens because pricing changes above that context size.

Each Agent thread in Neo Zed maintains its own context window.
