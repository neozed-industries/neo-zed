...
- **AI:** Zed doesn't store your prompts or code context. Data sharing for AI improvement is opt-in, and each share is a one-time action; it doesn't grant permission for future collection. You can use Neo Zed's AI features without sharing any data with Zed. See [AI Improvement](./ai-improvement.md).
