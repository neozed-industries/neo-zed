  ...
  commonArgs =
    ...
    rec {
      ...
      env = {
        ...
        ZED_UPDATE_EXPLANATION = "Neo Zed has been installed using Nix. Auto-updates have thus been disabled.";
    ...
    installPhase =
      if stdenv.hostPlatform.isDarwin then
        ''
          ...
          # Neo Zed expects git next to its own binary
          ...
          ln -s "$out/Applications/Neo Zed Nightly.app/Contents/MacOS/cli" $out/bin/neozed
        ...
        ''
          ...
          cp $TARGET_DIR/cli  $out/bin/neozed


          install -D "crates/zed/resources/app-icon-nightly@2x.png" \
            "$out/share/icons/hicolor/1024x1024@2x/apps/neozed.png"
          install -D crates/zed/resources/app-icon-nightly.png \
            $out/share/icons/hicolor/512x512/apps/neozed.png

          # TODO: icons should probably be named "neozed-nightly"
          (
            export DO_STARTUP_NOTIFY="true"
            export APP_CLI="neozed"
            export APP_ICON="neozed"
            export APP_NAME="Neo Zed Nightly"
            export APP_ARGS="%U"
